...
class ApplicationControllerTest {
    ...
    @Test
    void ApplicationController_CalculationPossibleCreditConditions_ReturnLoanOfferDTO() throws Exception {
        ...
        when(applicationService.calculationPossibleCreditConditions(loanApplicationRequestDTO)).thenReturn(expectedLoanOffers);
